...
export const sendDonationReceipt = async (donation, receiptNumber) => {
  const emailTemplate = `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
      <h2>Thank You for Your Donation!</h2>
      <p>Dear ${donation.firstName} ${donation.lastName},</p>
      <p>Thank you for your generous donation to Zongea Institute Of Technology. Your support helps us continue our mission of providing free education and mentorship.</p>
  ...
  const emailTemplate = `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
      ...
      <div style="background-color: #f5f5f5; padding: 15px; margin: 20px 0; border-radius: 5px;">
        ...
        <p>Date: ${new Date(donation.createdAt).toLocaleDateString()}</p>
        <p>Payment Method: ${donation.paymentMethod}</p>
        <p>Donation Type: ${donation.gifyType}</p>
