    ...
    <div className="font-sans text-gray-900">
      <section className="py-16 bg-gray-100 relative">
        <div className="ml-14">
          ...
          <p className="mt-2 text-gray-700 w-[37rem] max-w-full">
          ...
          <div className="relative mt-6 w-[40rem] max-w-full flex flex-col sm:flex-row sm:items-start gap-6">
            {/* Image Display */}
            <img src={images[activeIndex]} alt="Study at ZIT" className="w-full sm:w-[40rem] h-96 object-cover" />
            ...
            <div className="flex flex-col items-center sm:items-start w-full sm:w-auto">
              ...
              {/* Overlayed Content */}
              <div className=" lg:absolute lg:left-80 lg:top-32 bg-primary text-white p-6 w-full sm:w-[30rem] h-auto sm:h-52 shadow-lg mt-6 sm:mt-0">
                ...
                <Link to="/donate" className="flex justify-center items-center hover:text-primary hover:bg-white font-medium mt-4 text-white border border-1-white w-32 h-8 rounded-2xl">
                  Donate Today
                </Link>
              </div>
            </div>
