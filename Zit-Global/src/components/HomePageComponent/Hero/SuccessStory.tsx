                ...
                <div className="relative h-96 overflow-hidden" ref={carouselRef}>
                    <div className="flex items-center justify-center h-full">
                        {extendedStudents.map((student, index) => {
                            ...
                            const isMobileOnly = window.innerWidth < 768;
                            if (isMobileOnly && offset !== 0) return null;
                            ...
                            return (
                                <div 
                                    ...
                                    style={{
                                        transform: isMobileOnly ? 'translateX(0) scale(1)' : transform,
                                        opacity: isMobileOnly ? 1 : opacity,
                                        zIndex,
                                        width: '90%',
                                        maxWidth: '400px',
                                        left: '50%',
