...
const Analytics: React.FC = () => {
  return (
    <div>
      <h1 className="text-2xl font-bold mb-6 text-primary">Analytics Overview</h1>
      
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        {/* Traffic Sources */}
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="font-semibold text-primary">Traffic Sources</h3>
          ...
          <div className="h-64 flex items-end justify-between gap-2">
            {[65, 45, 75, 55, 85, 35, 95].map((height, index) => (
              <div key={index} className="flex-1">
                <div 
                  className="bg-gray-200 rounded-t-sm hover:bg-secondary/80 transition-all"
                  style={{ height: `${height}%` }}
                />
              </div>
            ))}
