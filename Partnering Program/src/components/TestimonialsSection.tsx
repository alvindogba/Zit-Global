    ...
    <section id="testimonials" className="py-24 bg-gradient-to-br from-blue-50 to-white">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-6 text-primary">What Our Partners Say</h2>
        ...
        <div className="max-w-4xl mx-auto relative">
          <div className="flex justify-between absolute top-1/2 -translate-y-1/2 w-full">
            <button 
              ...
              className="bg-white rounded-full p-2 shadow-md text-secondary hover:bg-blue-50 transition-all -ml-14 z-10"
            >
              <ChevronLeft size={24} />
            </button>
            <button 
              onClick={nextTestimonial}
              className="bg-white rounded-full p-2 shadow-md text-secondary hover:bg-blue-50 transition-all -mr-14 z-10"
            >
