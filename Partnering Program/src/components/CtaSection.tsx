      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <button 
            ...
            className="bg-white text-primary hover:scale-105 text-lg font-bold py-4 px-10 rounded-full transition-all shadow-lg hover:shadow-xl flex items-center gap-2 mx-auto"
          >
